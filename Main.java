...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Acct balance: " + sue.getName() + "--"  + sue.getBalance());

		System.out.println("Acct balance: " + joe.getName() + "--"  + joe.getBalance());
		
		System.out.println(joe.withdrawal( 300));

	//	System.out.println("At balance: " + joe.getName() + "--"  + joe.getBalance());
